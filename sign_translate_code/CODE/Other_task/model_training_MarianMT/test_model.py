...
# 載入微調後的模型
model = MarianMTModel.from_pretrained(latest_model_path)
tokenizer = MarianTokenizer.from_pretrained(latest_model_path)
...
# 合併 ROUGE 分數到 df
# 新增兩個欄位
df_rouge['AVE_rouge_1_f'] = df_rouge['rouge_1_f'].mean()
df_rouge['AVE_rouge_l_f'] = df_rouge['rouge_l_f'].mean()
